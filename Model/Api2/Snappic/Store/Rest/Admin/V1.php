 ...
 */
class AltoLabs_Snappic_Model_Api2_Snappic_Store_Rest_Admin_V1
    extends AltoLabs_Snappic_Model_Api2_Snappic_Store
{
    /**
    ...
    protected function _retrieve()
    {
        ...
        $store
            ...
            ->setMoneyWithCurrencyFormat(
                Mage::helper('core')->currency(10.00, true, false)
            );
