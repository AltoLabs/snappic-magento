 ...
 */
class AltoLabs_Snappic_Model_Api2_Snappic_Product_Rest_Admin_V1
    extends Mage_Catalog_Model_Api2_Product_Rest_Admin_V1
{
    /**
    ...
    protected function _retrieveCollection()
    {
        ...
        foreach ($collection as $product) { /** @var Mage_Catalog_Model_Product $product */
            ...
            $output[] = Mage::helper('altolabs_snappic')->getSendableProductData($product, true);
        }
