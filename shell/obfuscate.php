...
$obf = new FirstObfuscator();
$tempFile = $obf->obfuscate($argv[1]);
if ($obf->hasErrors()){
  print_r($obf->getAllErrors());
  die("Aborting.");
}

$obf = new SecondObfuscator();
$obf->file($tempFile);
$obf->strip          = true;
$obf->strip_comments = true;
$obf->b64            = true;
$obf->pack();
$obf->save($argv[1]);
